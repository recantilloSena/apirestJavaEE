...
@NamedQueries({
    ...
    , @NamedQuery(name = "PurchaseOrder.findByCustomerAndProduct", query = "SELECT p FROM PurchaseOrder p WHERE p.productId.productId =  :producto   AND p.customerId.customerId = :cliente ")
