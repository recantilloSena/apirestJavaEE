...
public class PurchaseOrderFacadeREST extends AbstractFacade<PurchaseOrder> {
    ...
    @GET
    @Path("p/{producto}/c/{cliente}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<PurchaseOrder> findByCustomerAndProduct(@PathParam("producto") Integer producto,@PathParam("cliente") Integer cliente  ) {
        return  em.createNamedQuery("PurchaseOrder.findByCustomerAndProduct")
